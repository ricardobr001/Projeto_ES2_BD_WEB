        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 portfolio-item">
                    <a href="paginas/comum.jsp" class="portfolio-link" data-toggle="modal">
                        <div class="caption">
                ...
                <div class="col-sm-6 portfolio-item">
                    <a href="paginas/ranking.jsp" class="portfolio-link" data-toggle="modal">
                        <div class="caption">
                            <div class="caption-content">
                                <i class="fa fa-search-plus fa-3x"></i>
                            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <p>Este projeto consiste em simular um sistema de buscas.</p>
                    <p>Com buscas avançadas de filmes, onde seram entrados os dados de idiomas e a especificação de um ou mais atores.</p>
                    <p>Também será necessário construir um sistema de ranking, onde será mostrado quais atores trabalham apenas com genero X e Y.</p>
                </div>
                <!--<div class="col-lg-4">
